...
namespace UIC_Edit_Workflow
{
    class FacilityInspectionModel : ValidatableBindableBase, IWorkTaskModel
    {
        ...
        {
            readOnlyInspectionIds = new ReadOnlyObservableCollection<string>(_facilityInspectionIds);
            Utils.RunOnUiThread(() =>
            {
        ...
        private readonly ObservableCollection<string> _facilityInspectionIds = new ObservableCollection<string>();
            ...
            await QueuedTask.Run(() =>
            {
                ...
                using (RowCursor cursor = uicWells.Search(qf))
                {
                    while (cursor.MoveNext())
                    {
                        ...
                        {
                            _facilityInspectionIds.Add(Convert.ToString(row["GUID"]));
                        }
                    }
                }
            });
        ...
        public bool IsInspectionAtributesComplete()
        {
